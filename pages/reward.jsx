    ...
    <>
      <div className="w-full h-[88vh] px-[1.6rem] flex flex-col">
        ...
        <div className="w-full h-[18vh] mt-[0.8rem] flex rounded-2xl border overflow-hidden">
          <div className="w-1/3 bg-toothPaste bg-cover bg-center opacity-80"></div>
          <div className="w-2/3 p-[1.2rem] flex flex-col justify-around">
            <h2 className="text-[2.4rem]">歯磨き粉</h2>
            <p className="text-[1.4rem]">
              <span className="text-gray-400">あと04日続けたらもらえる</span>
              <br />
              ECCさんの新作。爽やかなレモンの香りで、毎朝の歯磨きがリフレッシュタイムに。
            </p>
          </div>
        </div>
        <div className="w-full h-[18vh] mt-[0.8rem] flex rounded-2xl border overflow-hidden opacity-40">
          <div className="w-1/3 bg-toothBrush bg-cover bg-center"></div>
          <div className="w-2/3 p-[1.2rem] flex flex-col justify-around">
            <h2 className="text-[2.4rem]">歯ブラシ</h2>
            <p className="text-[1.4rem]">
        ...
        <div className="w-full h-[18vh] mt-[0.8rem] flex rounded-2xl border overflow-hidden opacity-40">
          <div className="w-1/3 bg-smile bg-cover bg-right"></div>
          <div className="w-2/3 p-[1.2rem] flex flex-col justify-around">
            <h2 className="text-[2.4rem]">ホワイトニング</h2>
            <p className="text-[1.4rem]">
              <span className="text-gray-400">あと00日続けたらもらえる</span>
              <br />
              先月オープンしたABC歯科。ホワイトニングの割引クーポン。
            </p>
          </div>
        </div>
        <div className="w-full h-[18vh] mt-[0.8rem] flex rounded-2xl border overflow-hidden opacity-40">
          ...
          <div className="w-2/3 p-[1.2rem] flex flex-col justify-around">
            <h2 className="text-[2.4rem]">デンタルフロス</h2>
            <p className="text-[1.4rem]">
              <span className="text-gray-400">あと00日続けたらもらえる</span>
              <br />
